        ...
        <div class="header-container">
            ...
            <div class="prova">
                ...
                <div class="carrello-buttons">
                    ...
                    <form action="azzera-carrello.php" method="get">
                            <button type="submit" id="azzera-button">Azzera</button>
                    </form>
                </div>
            </div>
            <form action="logout_page.php">
                <button type="submit" id="logout-button"><i class="fa-regular fa-user"></i><?php echo " " . $_SESSION['name']; ?><br><br>Logout <i class="fa-solid fa-right-to-bracket"></i></button>
            </form>
        </div>
    </header>
    <section class="hero">
        ...
        <div class="buttons">
            <div class="acquisto-container">
                <form action="aggiungi_carrello.php" method="get" id="form-acquisto">
                    <label aria-hidden="true">Aggiungi al carrello</label><br>
            ...
            <div class="prenotazione-container">
                <form action="prenotazione.php" method="GET" id="form-prenotazione">
                    <label aria-hidden="true">Prenota</label>
                    <select name="nome_prodotto" id="input3">
                        <?php
                            $host = "localhost";
                            $user = "root";
